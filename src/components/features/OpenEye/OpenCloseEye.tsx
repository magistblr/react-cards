...
import { OpenCloseEyeAC } from "../../../redux/reducers/loginReducer";
...
function OpenCloseEye(){
    ...
    return <div>
        {openCloseEye
            ? <svg onClick={() => funOpenCloseEye()} aria-hidden="true" focusable="false"
            ...
            : <svg onClick={() => funOpenCloseEye()} aria-hidden="true" focusable="false"
                   data-prefix="fas" data-icon="eye-slash" role="img"
